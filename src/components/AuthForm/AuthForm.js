    ...
    if (e.target.name === "confirmpassword") {
      if (this.state.password !== e.target.value) {
        ...
        this.setState({
          ...
          errors: null,
          formState: { confirm_password: null },
          confirmErrors: { confirm_password: null }
        });
      }
    }
      ...
      return (
        <Form onSubmit={this.handleLogin} error>
          ...
          <Form.Input
            ...
            error={this.state.formState.email}
          />
          <div>
            <Message
              error
          ...
          <Form.Input
            ...
            onChange={this.handleChange}
            error={this.state.formState.password}
          />
          <div>
            <Message
              error
      ...
      return (
        <Form onSubmit={this.handleSignup} error>
          ...
          <Form.Input
            ...
            onChange={this.handleChange}
            required
            error={this.state.formState.username}
          />
          ...
          <Form.Input
            ...
            onChange={this.handleChange}
            error={this.state.formState.confirm_password}
            required
          />
          <div>
            <Message
